<template>
  <div id="campusModel" :style="{width: `${width}px`, height: `${height}px`}"></div>
</template>
<script setup>
...
const initScene = () => {
  ...
  document.querySelector("#campusModel").appendChild( renderer.domElement );
  ...
  loadingInstance = ElLoading.service({
    target: document.querySelector("#campusModel"),
    text: "模型加载中...",
